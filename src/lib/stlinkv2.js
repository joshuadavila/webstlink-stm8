...
export default class Stlink {
    ...
    async read_coreid() {
        ...
        await this._connector.xfer([STLINK_SWIM_COMMAND, 0x0C, 0x00, 0x01, 0x00, 0x00, 0x7F, 0x99, 0xA0], {"rx_len": 1});
        ...
        await this._connector.xfer([STLINK_SWIM_COMMAND, 0x0C, 0x00, 0x01, 0x00, 0x00, 0x50, 0xCD, 0xA0], {"rx_len": 1});
        ...
        let rx = await this._connector.xfer([STLINK_SWIM_COMMAND, STLINK_SWIM_READBUF, 0x00, 0x04, 0x00, 0x00, 0x67, 0xF0], {"rx_len": 4});
